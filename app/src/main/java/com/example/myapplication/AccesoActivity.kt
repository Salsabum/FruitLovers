    ...
    override fun onCreate(savedInstanceState: Bundle?) {
                            ...
                            override fun onVerificationCompleted(credential : PhoneAuthCredential) {
                                auth.signInWithCredential(credential)
                                    .addOnSuccessListener {
                                        ...
                                        val intent = Intent(this@AccesoActivity, InicioActivity::class.java)
                                        intent.putExtra("mostrarFragmento", "productos")
                                        startActivity(intent)
                                        finish()
                                    }
                                    .addOnFailureListener {
                                        Toast.makeText(this@AccesoActivity, "CÃ³digo incorrecto", Toast.LENGTH_SHORT).show()
        ...
        ivGoogle.setOnClickListener {
            if (webClientId.isBlank()) {
                Toast.makeText(this, "Google Login no configurado en Firebase", Toast.LENGTH_SHORT).show()
            } else {
